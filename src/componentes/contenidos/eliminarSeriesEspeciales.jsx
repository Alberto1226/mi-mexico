...
import { eliminarSeriesEspeciales } from "../../api/seriesEspeciales";
import { ToastContainer, toast } from "react-toastify";
import { map } from "lodash";
import queryString from "query-string";

export default function EliminarSeriesEspeciales({ data, history, setShow }) {
  ...
  const onSubmit = (e) => {
    ...
    try {
      ...
      eliminarSeriesEspeciales(idSerie, dataTemp).then((response) => {
        const { data } = response;
        //notificacion
