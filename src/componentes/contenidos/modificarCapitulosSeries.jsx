...
import { actualizarCapitulosSeries } from "../../api/capitulosSeries";
...
export default function ModificarCapitulosSerie({ data, datos }) {
  const serie = data[0];
  const dataTemp = {
    temporada: data[1],
    nombre: data[2],
    ...
    if (
      ...
      try {
        ...
        const dataTemp = {
          ...
          urlCapitulo: !response?.url ? formData.urlCapitulo : response?.url,
        ...
        actualizarCapitulosSeries(serie, dataTemp).then((response) => {
          const { data } = response;
          //notificacion
      ...
      <div className="contact-form">
        <Form onSubmit={onSubmit} onChange={onChange}>
          <div className="imagenPrincipal">
            ...
            >
              <Dropzone setImagenFile={setImagenPortadaPelicula} imagenProductoBD={data[4]}/>
            </div>
          </div>
          <br />
          <div className="imagenPrincipal">
            ...
            <div
              ...
              className="imagenProducto"
            >
              <Dropzone setImagenFile={setImagenPortadaPeliculaMovil} imagenProductoBD={data[5]}/>
            </div>
          </div>
          <br />
          ...
          <div>
            ...
            <Col xs={12} md={12}>
              <Form.Control
                ...
                type="text"
                name="archPelicula"
                value={response?.url || formData.urlCapitulo}
                readOnly
              />
            </Col>
          </div>
