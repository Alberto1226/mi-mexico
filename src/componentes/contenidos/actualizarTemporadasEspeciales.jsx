...
function ActualizarTemporadasEspeciales({ history, data, setShow }) {
  console.log(data);
  ...
  const onSubmit = (e) => {
    e.preventDefault();
      ...
      try {
        ...
        actualizarSeriesEspeciales(idSerie, dataTemp)
          .then((response) => {
            const { data } = response;
            //notificacion
...
export default withRouter(ActualizarTemporadasEspeciales);
